...
_vec3 CPlayer::Piking_OnTerrain()
{
    ...
    //CStartMap* pTerrainBufferCom = dynamic_cast<CStartMap*>(Engine::Get_Component(ID_STATIC, L"Layer_GameLogic", L"StartMap", L"Com_Buffer"));
    //NULL_CHECK_RETURN(pTerrainBufferCom, _vec3());
    //
    //CTransform* pTerrainTransCom = dynamic_cast<CTransform*>(Engine::Get_Component(ID_DYNAMIC, L"Layer_GameLogic", L"StartMap", L"Com_Transform"));
    //NULL_CHECK_RETURN(pTerrainTransCom, _vec3());
